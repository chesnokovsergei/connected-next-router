...
var createAll = function createAll(structure) {
  return _objectSpread({}, actions, {
    initialRouterState: (0, _createInitialRouterState["default"])(structure),
    ConnectedRouter: (0, _ConnectedRouter["default"])(structure),
    routerReducer: (0, _reducer["default"])(structure),
    routerMethods: _routerMethods["default"],
    createRouterMiddleware: _middleware["default"]
  });
};

var _default = createAll;
