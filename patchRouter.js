...
exports.unpatchRouter = exports.patchRouter = void 0;

var _rewriteUrlForNextExport = _interopRequireDefault(require("./utils/rewriteUrlForNextExport"));
...
var patchRouter = function patchRouter(Router) {
...
var unpatchRouter = function unpatchRouter(Router) {
...
exports.unpatchRouter = unpatchRouter;
...
function timeTravelChange(url) {
  ...
  var _parse = (0, _url2.parse)(url, true),
